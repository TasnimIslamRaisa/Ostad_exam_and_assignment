...
import 'package:module_13/modal/productModal.dart';
import 'package:module_13/screens/addProductScreen.dart';
import 'package:module_13/screens/updateProductScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 94, 24, 24),
