...
class CreateWishListController extends GetxController {
  ...
  Future<bool> getCreatedWishtListById(String productId) async {
    bool isSuccess =false;
    if(AuthController.accessToken==null){
      _errorMsg="Access Token Expired or Missing";
      return false;
    }
    _inprogress = true;
    update();
    final NetworkResponse response =
    await Get.find<NetworkCaller>().getRequest(url: Urls.createWishList(productId),token: AuthController.accessToken);
